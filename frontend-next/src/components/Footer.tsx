      ...
      <div className="footer-inner" style={{ maxWidth: 1280, margin: '0 auto', display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', gap: 64, paddingBottom: 56, borderBottom: '1px solid var(--border)' }}>
        ...
        <div className="footer-brand" style={{ flex: '1 1 300px', maxWidth: 380, marginBottom: 24 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8, marginBottom: 4 }}>
            ...
            <a href="mailto:support@timelion.in" style={{ display: 'flex', alignItems: 'center', gap: 8, color: 'var(--text-sub)', fontSize: 13, textDecoration: 'none', transition: 'color 0.2s' }}
              onMouseEnter={(e) => (e.currentTarget.style.color = 'var(--gold)')}
              onMouseLeave={(e) => (e.currentTarget.style.color = 'var(--text-sub)')}>
              <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
          ...
          <nav className="footer-social-row" aria-label="Social media links">
            <a
              href="https://www.instagram.com/timelionin"
              target="_blank"
              rel="noopener noreferrer"
              className="footer-social-btn"
              aria-label="Follow Time Lion on Instagram"
            >
            ...
            <a
              href="https://www.facebook.com/timelionin"
              target="_blank"
              rel="noopener noreferrer"
              className="footer-social-btn"
              aria-label="Follow Time Lion on Facebook"
            >
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
